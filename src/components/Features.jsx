              ...
              <div className="flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 ">
                  <span>
                    ...
                    quis placeat consequuntur optio debitis distinctio ducimus
                    sequi nihil repudiandae omnis? Ipsam quasi fuga eveniet
                    quos, commodi debitis corrupti soluta accusamus?
                  </span>
                </h3>
              </div>
              ...
              <div className="flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 ">
                  <span>
                    ...
                    Deleniti tempore repellat quidem aliquid dicta odit aperiam
                    minus soluta eveniet, unde assumenda tempora non eligendi,
                    excepturi, maxime fugiat animi illo ea.
                  </span>
                </h3>
              </div>
            </div>
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            ...
            <p className="text-gray-500 sm:text-xl">
              ...
              a sunt saepe molestias! Voluptatum, blanditiis.
            </p>
          </div>
